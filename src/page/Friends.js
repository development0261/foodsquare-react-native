        ...
        return (
            <SideMenuDrawer ref={(ref) => this._sideMenuDrawer = ref}>
                <Container style={{ backgroundColor: '#ebeff0', position: 'relative' }}>
                    <Navbar left={left} title="Friends" marginLeft={25} fontSize={20} height={90} />
                    ...
                    <Row style={{ backgroundColor: 'white', height: 90, width: '100%' }}>
                        ...
                        <Col style={{ width: '65%' }}>
                            <View style={{ alignItems: 'center', justifyContent: 'center', marginLeft: -20 }}>
                                ...
                                <Segment style={{ marginTop: 10, backgroundColor: 'white', alignItems: 'center', justifyContent: 'center' }}>
