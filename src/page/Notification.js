...
export default class Notification extends Component {
        ...
        return (
            <SideMenuDrawer ref={(ref) => this._sideMenuDrawer = ref}>
                <Container style={{ backgroundColor: '#ebeff0', position: 'relative' }}>
                    <Navbar left={left} title="Notification" marginLeft={5} fontSize={20} height={90} />
                    ...
                    <Footer style={{ backgroundColor: Colors.navbarBackgroundColor }} backgroundColor={Colors.navbarBackgroundColor} >
                        <Body >
                            <View style={styles.body} >
                                <Text onPress={() => Actions.dishcreate()} style={{ color: 'white', textAlign: 'center', width: '100%', fontSize: 20, fontWeight: 'bold' }} >Read All</Text>
                            </View>
                        </Body>
                    </Footer>
                </Container>
    ...
    renderItemList = ({ item, index }) => {
        ...
        return (
            ...
            >
                <Card>
                    <Row style={{ backgroundColor: 'white', height: 90, width: '100%' }}>
                        <Col style={{ width: '25%' }}>
                            <View style={styles.MainContainer}>
                                <Image style={{ width: 70, height: 70, borderRadius: 200 / 2 }} source={{ uri: item.image }}>
                                </Image>
                            </View>
                        </Col>
                        <Col style={{ width: '65%' }}>
                        ...
                        <Col style={{ width: '5%' }}>
                            <View style={{ marginTop: 30, justifyContent: 'center', alignItems: 'center', height: 15, width: 15, backgroundColor: '#ff9500', borderRadius: 200 / 2 }}>
                            </View>
                        </Col>
                    </Row>
                </Card>
